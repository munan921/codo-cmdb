...
# 腾讯云账单余额告警阈值
QCLOUD_BILLING_THRESHOLD = os.getenv("QCLOUD_BILLING_THRESHOLD", "1000000")
# 火山云账单余额告警阈值
VOLC_BILLING_THRESHOLD = os.getenv("VOLC_BILLING_THRESHOLD", "200000")
# 阿里云账单余额告警阈值
ALIYUN_BILLING_THRESHOLD = os.getenv("ALIYUN_BILLING_THRESHOLD", "50000")
...
settings = dict(
    ...
    aliyun_billing_threshold=ALIYUN_BILLING_THRESHOLD,
