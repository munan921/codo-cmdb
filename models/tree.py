...
class TreeModels(BizBaseModel):
    ...
    node_type = Column(Integer, index=True, comment='节点类型,0:cmdb, 1: env, 2: set，, 3: module')
    node_sort = Column(Integer, default=100, index=True, comment="排序,字数越小越靠前")
